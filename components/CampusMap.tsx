...
const buildings = [
  // 08호관: 공과대학 + 도시과학대학 (캠퍼스 남서쪽, 아카데미로 입구 근처)
  { name: "공과대학",           lat: 37.3727, lng: 126.6291, college: "공과대학" },
  { name: "도시과학대학",       lat: 37.3724, lng: 126.6296, college: "도시과학대학" },
  // 07호관: 정보기술대학 (공과대학 북동쪽)
  { name: "정보기술대학",       lat: 37.3737, lng: 126.6307, college: "정보기술대학" },
  // 05호관: 자연과학대학 + 생명과학기술대학 (캠퍼스 중앙)
  { name: "자연과학대학",       lat: 37.3748, lng: 126.6318, college: "자연과학대학" },
  { name: "생명과학기술대학",   lat: 37.3751, lng: 126.6322, college: "생명과학기술대학" },
  // 13호관: 사회과학대학 (캠퍼스 북쪽)
  { name: "사회과학대학",       lat: 37.3758, lng: 126.6310, college: "사회과학대학" },
  // 14호관: 글로벌경영대학 (캠퍼스 북서쪽)
  { name: "글로벌경영대학",     lat: 37.3761, lng: 126.6299, college: "글로벌경영대학" },
  // 15호관: 인문대학 (캠퍼스 북쪽)
  { name: "인문대학",           lat: 37.3764, lng: 126.6313, college: "인문대학" },
  // 16호관: 예술체육대학 (캠퍼스 동쪽)
  { name: "예술체육대학",       lat: 37.3755, lng: 126.6330, college: "예술체육학부" },
]
