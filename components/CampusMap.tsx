...
const buildings = [
  ...
  // 08/28호관 — 도시과학대학 (공과대학 바로 남쪽)
  { name: "도시과학대학",       lat: 37.3730,    lng: 126.6323,    college: "도시과학대학" },
  // 07호관 — 정보기술대학 (Google Maps 실측)
  { name: "정보기술대학",       lat: 37.3744966, lng: 126.6334807, college: "정보기술대학" },
  // 05호관 — 자연과학대학 (학산도서관 남쪽)
  { name: "자연과학대학",       lat: 37.3743,    lng: 126.6343,    college: "자연과학대학" },
  // 05호관 — 생명과학기술대학 (자연과학대학 동측)
  { name: "생명과학기술대학",   lat: 37.3747,    lng: 126.6349,    college: "생명과학기술대학" },
  // 13호관 — 사회과학대학 (Google Maps 실측)
  ...
  // 16호관 — 예술체육대학 (경영대학 북동쪽)
  { name: "예술체육대학",       lat: 37.3764,    lng: 126.6335,    college: "예술체육학부" },
]
